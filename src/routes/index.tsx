      ...
      <section className="relative min-h-screen flex items-center px-6 lg:px-12 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] w-full">
          <ScrollReveal delay={100}>
            <h1 className="font-display font-black text-[clamp(2.5rem,11vw,11rem)] leading-[0.88] tracking-tighter pl-4 md:pl-8 lg:pl-12 pr-4 flex flex-col relative z-10 pt-8 break-words">
